$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/fr-fr/cloud-manager-cloud-volumes-service-gcp/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-gcp.fr-fr.zip";
